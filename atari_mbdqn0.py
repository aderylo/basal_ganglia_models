...
from custom_policy.meta_boltzman_dqn import DQNAttr, MBDPolicy
...
def main(args: argparse.Namespace = get_args()) -> None:
    ...
    # define value based model
    dqn_net = DQN(*args.state_shape, args.action_shape, args.device).to(args.device)
    dqn_optim = torch.optim.Adam(net.parameters(), lr=args.lr)

    # define DQN attirbutes
    dqn_attri = DQNAttr(
